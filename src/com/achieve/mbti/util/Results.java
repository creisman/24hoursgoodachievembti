...
public final class Results{
	 ...
	 public static final List<String> INFJ = Arrays.asList(new String[] {
		 "Art",
	 	 "Communication",
	 	 "Psychology",
	 	 "Latin American",
	 ...
	 public static final List<String> INTJ = Arrays.asList(new String[] {
		 "Biochemistry",
	 	 "Psychology",
	 	 "Finance",
	 	 "Mathematics",
	 ...
	 public static final List<String> ISTP = Arrays.asList(new String[] {
		 "Biology",
	 	 "Finance",
	 	 "Law and Social",
	 	 "Thought",
	 ...
	 public static final List<String> ISFP = Arrays.asList(new String[] {
		 "Art",
	 	 "Psychology",
	 	 "Exercise Science",
	 	 "Law and Social",
	 ...
	 public static final List<String> INFP = Arrays.asList(new String[] {
		 "Management",
	 	 "History",
	 	 "Medical Technology",
	 	 "Foreign Languages",
	 ...
	 public static final List<String> INTP = Arrays.asList(new String[] {
		 "Chemistry",
	 	 "Information Systems",
	 	 "Criminal Justice",
	 	 "Economics",
	 ...
	 public static final List<String> ESTP = Arrays.asList(new String[] {
		 "Art",
	 	 "Biology",
	 	 "Information Systems",
	 	 "Medical Technology",
	 ...
	 public static final List<String> ESFP = Arrays.asList(new String[] {
		 "Psychology",
	 	 "Exercise Science",
	 	 "Geology",
	 	 "Nursing",
	 ...
	 public static final List<String> ENFP = Arrays.asList(new String[] {
		 "Anthropology",
	 	 "Art",
	 	 "Chemistry",
	 	 "Early Childhood",
	 ...
	 public static final List<String> ENTP = Arrays.asList(new String[] {
	 ...
	 public static final List<String> ESTJ = Arrays.asList(new String[] {
		 "Mechanical",
	 	 "Engineering",
	 	 "Public Relations",
	 	 "Music",
	 ...
	 public static final List<String> ESFJ = Arrays.asList(new String[] {
		 "Psychology",
	 	 "Marketing",
	 	 "Nursing",
	 	 "Physical Education",
	 ...
	 public static final List<String> ENFJ = Arrays.asList(new String[] {
		 "Communication",
	 	 "Psychology",
	 	 "Management",
	 	 "Marketing",
	 ...
	 public static final List<String> ENTJ = Arrays.asList(new String[] {
		 "Economics",
