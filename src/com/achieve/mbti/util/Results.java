...
public final class Results{
	 ...
	 public static final PersonalityInfo[] ISTJ = new PersonalityInfo[]{
		 ...
		 new PersonalityInfo(Arrays.asList( new String[] {
		 	...
		 	"One of two most overrepresented female types in a substance abuse program."}), EvalType.FACTS)};
/*
	 public static final PersonalityInfo[] ISFJ =  new PersonalityInfo[]{
		 new PersonalityInfo(Arrays.asList(new String[] {
	 	 ...
	 	 "Among substance abusers, are attracted to heroin."}), EvalType.FACTS)};
	 ...
	 public static final PersonalityInfo[] INFJ =  new PersonalityInfo[]{
		 new PersonalityInfo(Arrays.asList(new String[] {
	 	 ...
	 	 "Among the 3 male types most “oblivious” to partner’s dissatisfaction with the relationship."}), EvalType.FACTS)};
	 ...
	 public static final PersonalityInfo[] ISTP =  new PersonalityInfo[]{
		 new PersonalityInfo(Arrays.asList(new String[] {
	 	 ...
	 	 "In national sample, highest in coping with stress by “Getting upset or angry and not showing it.”"}), EvalType.FACTS)};
	 ...
	 public static final PersonalityInfo[] ISFP =  new PersonalityInfo[]{
		 new PersonalityInfo(Arrays.asList(new String[] {
	 	 ...
	 	 "In national sample, highest in coping with stress by “Trying to avoid stressful situations,” “Getting upset or angry and not showing it,” “Sleeping,” and “Watching TV.”"}), EvalType.FACTS)};
	 ...
	 public static final PersonalityInfo[] INFP =  new PersonalityInfo[]{
		 new PersonalityInfo(Arrays.asList(new String[] {
	 	 ...
	 	 "Overrepresented among a sample of male therapists."}), EvalType.FACTS)};
	 ...
	 public static final PersonalityInfo[] INTP =  new PersonalityInfo[]{
		 new PersonalityInfo(Arrays.asList(new String[] {
	 	 ...
	 	 "Most frequent among college students referred for drug and alcohol violations."}), EvalType.FACTS)};
	 ...
	 public static final PersonalityInfo[] ESTP =  new PersonalityInfo[]{
		 new PersonalityInfo(Arrays.asList(new String[] {
	 	 ...
	 	 "In national sample, ranked 4th highest in satisfaction with “Marriage/intimate relationship.”"}), EvalType.FACTS)};
	 ...
	 public static final PersonalityInfo[] ESFP =  new PersonalityInfo[]{
		 new PersonalityInfo(Arrays.asList(new String[] {
	 	 ...
	 	 "In national sample, ranked 2nd highest in satisfaction with “Marriage/intimate relationship.”"}), EvalType.FACTS)};
	 ...
	 public static final PersonalityInfo[] ENFP =  new PersonalityInfo[]{
		 new PersonalityInfo(Arrays.asList(new String[] {
	 	 ...
	 	 "In national sample, ranked lowest in coping with stress by “Developing physical symptoms.”"}), EvalType.FACTS)};
	 ...
	 public static final PersonalityInfo[] ENTP =  new PersonalityInfo[]{
		 new PersonalityInfo(Arrays.asList(new String[] {
	 	 ...
	 	 "In national sample, ranked lowest in “Ever had heart disease/hypertension.”"}), EvalType.FACTS)};
	 ...
	 public static final PersonalityInfo[] ESTJ =  new PersonalityInfo[]{
		 new PersonalityInfo(Arrays.asList(new String[] {
			 "Mechanical",
		 	 ...
		 	 "Accounting",
		 	 "Finance",
		 	 "Political Science"}), EvalType.MAJORS),
	 	 ...
	 	 "Overrepresented among those having Type A behavior.",
	 	 "In national sample, ranked 3rd highest in satisfaction with “Marriage/intimate relationship.”"}), EvalType.FACTS)};
	 ...
	 public static final PersonalityInfo[] ESFJ =  new PersonalityInfo[]{
	 	...
	 	"In national sample, ranked highest in satisfaction with “Marriage/intimate relationship.”"}), EvalType.FACTS)};
	 ...
	 public static final PersonalityInfo[] ENFJ =  new PersonalityInfo[]{
		 new PersonalityInfo(Arrays.asList(new String[] {
			...
			"Public Relations",
			"Urban Studies",
			"Foreign Languages"}), EvalType.MAJORS),
	 	 
			 new PersonalityInfo(Arrays.asList(new String[] {"Rated by psychologists among 2 types least likely to have trouble in school.",
	 	...
	 	"In national sample, ranked highest in “Belief in a higher spiritual power.”"}), EvalType.FACTS)};
	 ...
	 public static final PersonalityInfo[] ENTJ =  new PersonalityInfo[]{
	 	...
	 	"In national sample, ranked 2nd highest in “No” and 4th highest in “Not sure” re: “Belief in higher spiritual power.”"}), EvalType.FACTS)};
	 */
	//static initializer
		 static{
